...
All maps here are available under the CC-BY-SA-4.0 license, which you can find in this repository's [LICENSE.md](https://github.com/zzufx/zzuf-maps/blob/master/LICENSE.md)

# Folders
A description of each folder's contents

### 1.8-maps
This is a collection of maps I've worked on where I had complete or the biggest share of creative input. These maps are compatible with Minecraft 1.8 and above.
